...
const ReportDetailView = () => {
  ...
  const fetchReportDetail = async () => {
    try {
      ...
      const matchingReport = res.data.reports.find(
        (r) => r._id === reportId
      );
  ...
  if (loading) {
    return <div className="loading-spinner">Loading report details...</div>;
  }
  ...
  if (!report) {
    return <div className="error-message">Report data not available</div>;
  }
      ...
      <div className="report-content">
        ...
        <div className="report-grid">
          ...
          <div className="station-card">
            ...
            <h3>{report.assignedStation?.name || "Not assigned"}</h3>
          ...
          <div className="officers-card">
            <h2>
              ASSIGNED OFFICERS ({report.assignedOfficers?.length || 0})
            </h2>
